...
from userbot.utils import progress, humanbytes, edit_or_reply, edit_delete, kay_cmd


@kay_cmd(pattern="download(?: |$)(.*)")
...
@kay_cmd(pattern="uploadas(stream|vn|all) (.*)")
